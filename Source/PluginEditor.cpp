...
//Colors
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void PlasmaAudioProcessorEditor::loadBackgroundColor(PropertiesFile* userSettings)
{
	auto r = userSettings->getIntValue("backgroundColorRed", backgroundColorFallback.getRed());
	auto g = userSettings->getIntValue("backgroundColorGreen", backgroundColorFallback.getGreen());
	auto b = userSettings->getIntValue("backgroundColorBlue", backgroundColorFallback.getBlue());
	setBackgroundColor(Colour(r, g, b));
}

void PlasmaAudioProcessorEditor::loadForegroundColor(PropertiesFile* userSettings)
{
	auto r = userSettings->getIntValue("foregroundColorRed", foregroundColorFallback.getRed());
	auto g = userSettings->getIntValue("foregroundColorGreen", foregroundColorFallback.getGreen());
	auto b = userSettings->getIntValue("foregroundColorBlue", foregroundColorFallback.getBlue());
	setForegroundColor(Colour(r, g, b));
}

void PlasmaAudioProcessorEditor::loadAccentColor(PropertiesFile* userSettings)
{
	auto r = userSettings->getIntValue("accentColorRed", accentColorFallback.getRed());
	auto g = userSettings->getIntValue("accentColorGreen", accentColorFallback.getGreen());
	auto b = userSettings->getIntValue("accentColorBlue", accentColorFallback.getBlue());
	setAccentColor(Colour(r, g, b));
}

void PlasmaAudioProcessorEditor::saveBackgroundColor(PropertiesFile* userSettings)
{
...
void PlasmaAudioProcessorEditor::saveForegroundColor(PropertiesFile* userSettings)
{
...
void PlasmaAudioProcessorEditor::saveAccentColor(PropertiesFile* userSettings)
{
...
void PlasmaAudioProcessorEditor::loadOscilloscopeBufferSize(PropertiesFile* userSettings)
{
	oscilloscopeBufferSize = userSettings->getIntValue("oscilloscopeBufferSize", oscilloscopeBufferSizeFallback);
	waveformComponent->setBufferSize(oscilloscopeBufferSize);
}

void PlasmaAudioProcessorEditor::loadOscilloscopeSamplesPerBlock(PropertiesFile* userSettings)
{
	oscilloscopeSamplesPerBlock = userSettings->getIntValue("oscilloscopeSamplesPerBlock", oscilloscopeSamplesPerBlockFallback);
...
void PlasmaAudioProcessorEditor::saveOscilloscopeBufferSize(PropertiesFile* userSettings)
{
	userSettings->setValue("oscilloscopeBufferSize", oscilloscopeBufferSize);
}

void PlasmaAudioProcessorEditor::saveOscilloscopeSamplesPerBlock(PropertiesFile* userSettings)
{
	userSettings->setValue("oscilloscopeSamplesPerBlock", oscilloscopeSamplesPerBlock);
}
