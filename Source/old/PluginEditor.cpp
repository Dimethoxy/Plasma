...
//Editor
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
PlasmaAudioProcessorEditor::PlasmaAudioProcessorEditor(PlasmaAudioProcessor& p) : AudioProcessorEditor(&p), audioProcessor(p),
	                                                                              driveTypeSlider(*audioProcessor.apvts.getParameter("Drive Type"), ""),
	                                                                              biasSlider(*audioProcessor.apvts.getParameter("Bias"), ""),
	                                                                              highPassResonanceSlider(*audioProcessor.apvts.getParameter("Highpass Resonance"), "dB"),
	                                                                              highPassResonanceQualitySlider(*audioProcessor.apvts.getParameter("Highpass Resonance Q"), ""),
	                                                                              ...
	                                                                              lowPassResonanceQualitySlider(*audioProcessor.apvts.getParameter("Lowpass Resonance Q"), ""),
	                                                                              lowPassResonanceSlider(*audioProcessor.apvts.getParameter("Lowpass Resonance"), "dB"),
...
void PlasmaAudioProcessorEditor::resized()
{
	...
	//Latedrive
	gainSlider.setBounds(sq(18.0), sq(5), sq(1.5), sq(5.5));
	lateDriveSlider.setBounds(sq(16.5), sq(5), sq(1.5), sq(5.5));
	lateGirthSlider.setBounds(sq(15.0), sq(5), sq(1.5), sq(5.5));
