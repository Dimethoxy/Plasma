...
namespace BinaryData
{
    ...
    extern const char*   PoppinsBlackItalic_ttf;
    const int            PoppinsBlackItalic_ttfSize = 171544;

    extern const char*   PoppinsBold_ttf;
    const int            PoppinsBold_ttfSize = 153900;

    extern const char*   PoppinsBoldItalic_ttf;
    const int            PoppinsBoldItalic_ttfSize = 176552;

    extern const char*   PoppinsExtraBold_ttf;
    const int            PoppinsExtraBold_ttfSize = 152712;

    extern const char*   PoppinsExtraBoldItalic_ttf;
    const int            PoppinsExtraBoldItalic_ttfSize = 173868;

    extern const char*   PoppinsExtraLight_ttf;
    const int            PoppinsExtraLight_ttfSize = 161404;

    extern const char*   PoppinsExtraLightItalic_ttf;
    const int            PoppinsExtraLightItalic_ttfSize = 186124;

    extern const char*   PoppinsItalic_ttf;
    const int            PoppinsItalic_ttfSize = 181972;

    extern const char*   PoppinsLight_ttf;
    const int            PoppinsLight_ttfSize = 159848;

    extern const char*   PoppinsLightItalic_ttf;
    const int            PoppinsLightItalic_ttfSize = 184420;

    extern const char*   PoppinsMedium_ttf;
    const int            PoppinsMedium_ttfSize = 156480;

    extern const char*   PoppinsMediumItalic_ttf;
    const int            PoppinsMediumItalic_ttfSize = 180412;
    ...
    extern const char*   PoppinsSemiBoldItalic_ttf;
    const int            PoppinsSemiBoldItalic_ttfSize = 178548;
