...
OutputBaseFilename=plasma-1.3.0-windows
DirExistsWarning=no
UninstallFilesDir={app}\Plasma
UninstallDisplayIcon={app}\Plasma\uninstall.ico

[Files]
Source: "..\..\Builds\VisualStudio2022\x64\Release\VST3\Plasma.vst3"; DestDir: "{app}\Plasma"; Flags: recursesubdirs replacesameversion
